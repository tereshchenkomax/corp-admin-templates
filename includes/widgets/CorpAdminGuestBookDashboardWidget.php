...
class CorpAdminGuestBookDashboardWidget implements  CorpAdminCreatorInstance
{
    ...
    public function addDashboardWidgets(){
        ...
        add_meta_box(
            'corp_admin_guest_book_dashboard_widget_new',
            __('Guest book new', CORPADMINTEMPLATES_PlUGIN_TEXTDOMAIN),
        ...
        wp_add_dashboard_widget(
            'corp_admin_guest_book_dashboard_widget_new',         // Идентификатор виджета.
            __('Guest book', CORPADMINTEMPLATES_PlUGIN_TEXTDOMAIN),           // Заголовок виджета.
