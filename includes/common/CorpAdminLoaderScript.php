...
class CorpAdminLoaderScript
{
    ...
    public function loadScriptAdmin($hook){
        ...
        wp_register_script(
            CORPADMINTEMPLATES_PlUGIN_SLUG.'-AdminMain', //$handle
            CORPADMINTEMPLATES_PlUGIN_URL.'assets/admin/js/CorpAdminAdminMain.js', //$src
            array(
                'jquery'
            ), //$deps
            CORPADMINTEMPLATES_PlUGIN_VERSION, //$ver
            true //$$in_footer
        );
        /**
         ...
         */
        wp_enqueue_script(CORPADMINTEMPLATES_PlUGIN_SLUG.'-AdminMain');
        ...
        wp_register_style(
            CORPADMINTEMPLATES_PlUGIN_SLUG.'-AdminMain', //$handle
            CORPADMINTEMPLATES_PlUGIN_URL.'assets/admin/css/CorpAdminMain.css', // $src
            array(), //$deps,
            CORPADMINTEMPLATES_PlUGIN_VERSION // $ver
        );
        /**
         ...
         */
        wp_enqueue_style(CORPADMINTEMPLATES_PlUGIN_SLUG.'-AdminMain');
    ...
    public function loadHeadScriptAdmin(){
        ...
        <script type="text/javascript">
            var corpAdminAjaxUrl;
            corpAdminAjaxUrl  = '<?php echo CORPADMINTEMPLATES_PlUGIN_AJAX_URL; ?>';
        </script>
        <?php
    }
    ...
    public function loadScriptSite($hook){
        ...
        $version = null;
        wp_register_script(
            CORPADMINTEMPLATES_PlUGIN_SLUG.'-Main', //$handle
            CORPADMINTEMPLATES_PlUGIN_URL.'assets/site/js/CorpAdminMain.js', //$src
            array(
                'jquery'
            ), //$deps
            $version, //$ver
         ...
         * Зависимые скрипты добавляются автоматически.
         */
        wp_enqueue_script(CORPADMINTEMPLATES_PlUGIN_SLUG.'-Main');
        // Добавим ajaxurl переменую до скрипта будем использовать функцию
        // wp_add_inline_script( $handle, $data, $position );

        $data = 'var ajaxurl = "'.CORPADMINTEMPLATES_PlUGIN_AJAX_URL.'";';

        wp_add_inline_script( CORPADMINTEMPLATES_PlUGIN_SLUG.'-Main', $data, 'before' );
    }
